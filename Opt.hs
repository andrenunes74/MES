...
optExp (Not (Or e1 e2)) = And (optExp e1) (optExp e2)
optExp (Not (And e1 e2)) = Or (optExp e1) (optExp e2)
optExp (Not (Less e1 e2)) = GTE (optExp e1) (optExp e2)
optExp (Not (Greater e1 e2)) = LTE (optExp e1) (optExp e2)
optExp (Not (LTE e1 e2)) = Greater (optExp e1) (optExp e2)
optExp (Not (GTE e1 e2)) = Less (optExp e1) (optExp e2)
optExp (Not (Not e1)) = (optExp e1)
